...
class BestMatch(LogicAdapter):
    ...
    #############
            print("We are trying for Google search..1..")
    ...
    ##############
            print("We are trying for Google search..2..")
    ...
    #############
            print("We are trying for Google search..3..")

        else:
            response = self.get_default_response(input_statement)
    ######
            print("We are trying for Google search..4..")
